...
namespace Twenty57.Linx.Components.Pdf.Concatenate.Templates
{
    ...
    #line 1 "D:\Hg\Linx5Components\PDF\PDF-2455\Linx5.Components.PDF\src\Pdf\Concatenate\Templates\ConcatenateTemplate.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 3 "D:\Hg\Linx5Components\PDF\PDF-2455\Linx5.Components.PDF\src\Pdf\Concatenate\Templates\ConcatenateTemplate.tt"
            ...
            #line 4 "D:\Hg\Linx5Components\PDF\PDF-2455\Linx5.Components.PDF\src\Pdf\Concatenate\Templates\ConcatenateTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(OutputFilePathParameterName));
            ...
            #line 9 "D:\Hg\Linx5Components\PDF\PDF-2455\Linx5.Components.PDF\src\Pdf\Concatenate\Templates\ConcatenateTemplate.tt"
            ...
            #line 10 "D:\Hg\Linx5Components\PDF\PDF-2455\Linx5.Components.PDF\src\Pdf\Concatenate\Templates\ConcatenateTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(OutputFilePathParameterName));
            
            #line default
            #line hidden
            this.Write(", System.IO.FileMode.Create))\r\n\tusing (var document = new iTextSharp.text.Documen" +
                    "t())\r\n\tusing (var pdfCopy = new iTextSharp.text.pdf.PdfCopy(document, outputStre" +
                    "am))\r\n\t{\r\n\t\tpdfCopy.SetMergeFields();\r\n\t\tdocument.Open();\r\n\t\tforeach (string inp" +
                    "utFile in ");
            
            #line 16 "D:\Hg\Linx5Components\PDF\PDF-2455\Linx5.Components.PDF\src\Pdf\Concatenate\Templates\ConcatenateTemplate.tt"
            ...
            #line 21 "D:\Hg\Linx5Components\PDF\PDF-2455\Linx5.Components.PDF\src\Pdf\Concatenate\Templates\ConcatenateTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(ContextParameterName));
...
finally
{
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    internal class ConcatenateTemplateBase
    {
        #region Fields
